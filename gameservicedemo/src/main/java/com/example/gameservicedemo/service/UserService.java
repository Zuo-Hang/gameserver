...
public class UserService {
    ...
    public void logoutUser(ChannelHandlerContext context, Integer userId) {
        ...
        //先将player退出，
        PlayerBeCache playerByContext = playerService.getPlayerByContext(context);
        Optional.ofNullable(playerByContext).ifPresent(p -> playerService.logoutScene(context));
        //从用户的缓存中移除，
